  ...
  return (
    <><div className="stats-grid">
      ...
      <div className="stat-card green">
        ...
        <div className="stat-footer"><span className="stat-footer-label">OF {getMaxScore('sat-rw')}</span><div className="stat-bar"><div className="stat-bar-fill" style={{ width: `${rwScore ? (rwScore / getMaxScore('sat-rw')) * 100 : 0}%` }} /></div></div>
      </div>
    ...
    <div className="dash-grid-2col">
      ...
      <div className="dash-card">
        ...
        <div className="quick-actions">
          <button className="qa-btn" onClick={() => navigate('/practice-tests')}><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="12" y1="18" x2="12" y2="12" /><line x1="9" y1="15" x2="15" y2="15" /></svg>NEW PRACTICE TEST</button>
          <button className="qa-btn" onClick={() => navigate('/profile')}><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M18 20V10" /><path d="M12 20V4" /><path d="M6 20v-4" /></svg>SCORE ANALYSIS</button>
          <button className="qa-btn" onClick={() => navigate('/study-plan')}><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></svg>STUDY PLANNER</button>
          <button className="qa-btn" onClick={() => navigate('/sat-math')}><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 20h9" /><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z" /></svg>REVIEW WEAK AREAS</button>
        </div>
      </div>
    </div>
